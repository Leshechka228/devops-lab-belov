...
class WebhookHandler(BaseHTTPRequestHandler):
    ...
    def do_GET(self):
        ...
        <html>
        <head>
            <title>DevOps Webhook Demo - belov</title>
            <meta charset="utf-8">
            <style>
...
def main():
    ...
    print(f"🚀 Запуск DevOps Webhook Demo Server - belov")
    print(f"📡 Порт: {PORT}")
    print(f"🌐 URL: http://0.0.0.0:{PORT}")
    print(f"🔧 Webhook URL: http://webhook.belov.course.prafdin.ru")
